            ...
            <div class="p-6">
                ...
                <div class="flex items-start justify-between mb-5">
                    <div class="flex items-start space-x-4">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-sm font-medium {{ $color['text'] }} mb-1">{{ $doctor->specialty->name ?? 'N/A' }}</p>
                    ...
                    <div class="flex-shrink-0 ml-2">
                        @if ($doctor->user->status === 'active')
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium bg-emerald-100 text-emerald-800 border border-emerald-200">
                                Active
                            </span>
                        ...
                        @else
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded text-xs font-medium bg-amber-100 text-amber-800 border border-amber-200">
                ...
                <div class="bg-gray-50 rounded-lg px-4 py-3 mb-5 border border-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-lg font-semibold text-gray-900">₹{{ number_format($doctor->consultation_fee, 0) }}</span>
                    </div>
                </div>
