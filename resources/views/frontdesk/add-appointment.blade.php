...
<div class="max-w-4xl mx-auto">
    <form class="space-y-4 sm:space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
            ...
            <div class="mb-4">
                ...
                <div class="flex flex-col sm:flex-row gap-2">
                    ...
                    <button type="button" class="px-4 sm:px-6 py-2 bg-sky-600 text-white rounded-lg hover:bg-sky-700 text-sm sm:text-base">
                        Search
                    </button>
                </div>
            </div>
            ...
            <div class="flex items-center my-4 sm:my-6">
                ...
                <span class="px-3 sm:px-4 text-xs sm:text-sm text-gray-500">OR</span>
                <div class="flex-1 border-t border-gray-300"></div>
            </div>

            <div class="mb-4">
                <button type="button" class="px-3 sm:px-4 py-2 border border-sky-600 text-sky-600 rounded-lg hover:bg-sky-50 text-sm sm:text-base">
                    + Add New Patient
                </button>
            </div>

            <!-- New Patient Form (Initially hidden, shown when "Add New Patient" is clicked) -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 mt-4 sm:mt-6 p-3 sm:p-4 bg-sky-50 rounded-lg border border-sky-200">
                <div class="col-span-1 md:col-span-2">
                    <p class="text-xs sm:text-sm font-medium text-sky-800 mb-3">New Patient Details</p>
                </div>
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">First Name *</label>
                    <input type="text" required class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="email" required class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
                </div>
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Phone *</label>
                    <input type="tel" required class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
                </div>
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Date of Birth *</label>
                    <input type="date" required class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
                </div>
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Gender *</label>
                    <select required class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
        ...
        <!-- Payment Information -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
            <h3 class="text-base sm:text-lg font-semibold text-gray-800 mb-4">Payment Information</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Payment Method</label>
                ...
                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Amount</label>
                    <input type="text" value="$150.00"
                           class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
                </div>

                <div>
                    <label class="block text-xs sm:text-sm font-medium text-gray-700 mb-2">Transaction ID</label>
        ...
        <div class="flex flex-col sm:flex-row items-center justify-end gap-3 sm:gap-4">
            <button type="button" class="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 text-sm sm:text-base">
                Cancel
            </button>
            <button type="button" class="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 text-sm sm:text-base">
                Save as Draft
            </button>
            <button type="submit" class="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 bg-sky-600 text-white rounded-lg hover:bg-sky-700 text-sm sm:text-base">
                Book Appointment
            </button>
        </div>
    </form>
