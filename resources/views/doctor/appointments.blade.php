...
<div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-3 sm:gap-4">
        <div>
            ...
            <input type="date" class="w-full px-3 sm:px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm sm:text-base">
        </div>
        <div>
...
<div class="bg-white rounded-xl shadow-sm border border-gray-100">
    ...
    <div class="divide-y">
        ...
        <div class="p-4 sm:p-6 hover:bg-gray-50">
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1">
                    <div class="w-16 h-16 bg-sky-100 rounded-lg flex flex-col items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 space-y-2">
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Reason:</span> Chest pain and irregular heartbeat</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Phone:</span> +1 (555) 123-4567</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Allergies:</span> Penicillin</p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-start lg:items-end gap-2">
                    ...
                    <div class="flex flex-col sm:flex-row gap-2 w-full lg:w-auto mt-2">
                        ...
                        <button class="px-3 sm:px-4 py-2 bg-green-600 text-white text-xs sm:text-sm rounded-lg hover:bg-green-700">
                            Mark Complete
                        </button>
                    </div>
                </div>
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 space-y-2">
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Reason:</span> Follow-up consultation for hypertension</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Phone:</span> +1 (555) 234-5678</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Allergies:</span> None</p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-start lg:items-end gap-2">
            ...
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 space-y-2">
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Reason:</span> Annual cardiac checkup</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Phone:</span> +1 (555) 345-6789</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Allergies:</span> Aspirin</p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-start lg:items-end gap-2">
        ...
        <div class="p-4 sm:p-6 hover:bg-gray-50 opacity-60">
            <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4">
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 flex-1">
                    <div class="w-16 h-16 bg-gray-100 rounded-lg flex flex-col items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="mt-3 space-y-2">
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Reason:</span> Heart palpitations during exercise</p>
                            <p class="text-xs sm:text-sm text-gray-700"><span class="font-medium">Phone:</span> +1 (555) 456-7890</p>
                        </div>
                    </div>
                </div>
                <div class="flex flex-col items-start lg:items-end gap-2">
