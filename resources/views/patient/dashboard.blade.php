...
<body class="p-4 md:p-8">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        <div class="bg-gradient-to-r from-blue-50 to-white rounded-xl shadow-sm p-5 border border-blue-100 hover:shadow-md transition-shadow duration-300">
        ...
        <div class="bg-gradient-to-r from-sky-50 to-white rounded-xl shadow-sm p-5 border border-sky-100 hover:shadow-md transition-shadow duration-300">
            <div class="flex items-center">
        ...
        <div class="bg-gradient-to-r from-green-50 to-white rounded-xl shadow-sm p-5 border border-green-100 hover:shadow-md transition-shadow duration-300">
            <div class="flex items-center">
        ...
        <div class="bg-gradient-to-r from-emerald-50 to-white rounded-xl shadow-sm p-5 border border-emerald-100 hover:shadow-md transition-shadow duration-300">
            <div class="flex items-center">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 bg-gradient-to-r from-sky-50 to-white">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                ...
                <a href="{{ route('booking') }}"
                    class="mt-3 sm:mt-0 inline-flex items-center px-4 py-2 bg-sky-600 text-white font-medium rounded-lg hover:bg-sky-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-sky-500 transition-all duration-200 text-sm">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                    </svg>
    ...
    <div class="appointment-card bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg hover:border-sky-200 transition-all duration-300"
        ...
        <div class="p-6">
            ...
            <div class="flex items-start mb-4">
                <div class="w-12 h-12 rounded-full bg-gradient-to-br from-blue-100 to-sky-50 flex items-center justify-center flex-shrink-0 ring-2 ring-blue-50">
            ...
            <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                <div class="flex items-center space-x-3">
                    @if ($appointment->has_prescription)
                        <span class="inline-flex items-center text-green-600 bg-green-50 px-2.5 py-1.5 rounded-lg" title="Prescription Available">
