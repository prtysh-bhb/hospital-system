            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6">
                ...
                <div class="grid grid-cols-7 gap-1 sm:gap-2 mb-6">
                    ...
                    @foreach ($calendar as $day)
                        @php
                            $classes = 'calendar-day p-2 sm:p-3 rounded-lg text-xs sm:text-sm text-center';
                            ...
                            if ($isPast) {
                                ...
                                $classes .= ' bg-sky-200 text-gray-800 font-semibold cursor-pointer';
                            } else {
                                $classes .= ' text-gray-800 hover:bg-sky-50 cursor-pointer';
                            }
                        @endphp
