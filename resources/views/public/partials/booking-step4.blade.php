    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
      <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 sm:gap-0">
        <div class="flex items-center flex-1 min-w-0">
          <div class="flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-sky-600 text-white font-semibold text-sm sm:text-base flex-shrink-0">
            ✓
          </div>
  ...
  <main class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden mb-4 sm:mb-6">
      <div class="bg-gradient-to-r from-green-50 to-emerald-50 p-4 sm:p-8 text-center border-b border-gray-200">
        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
      ...
      <div class="bg-sky-50 p-4 sm:p-6 border-b border-gray-200">
        <div class="text-center">
          ...
          <div class="text-3xl sm:text-4xl font-bold text-sky-600 tracking-wider mb-2">APT-2025-001234</div>
      ...
      <div class="p-4 sm:p-8">
        ...
        <div class="space-y-3 sm:space-y-4">
          ...
          <div class="flex items-start p-3 sm:p-4 bg-gray-50 rounded-lg">
            <div class="w-14 h-14 sm:w-16 sm:h-16 bg-sky-100 rounded-lg flex items-center justify-center text-sky-600 font-semibold text-lg sm:text-xl flex-shrink-0">
              DR
            </div>
            <div class="ml-3 sm:ml-4 flex-1 min-w-0">
              <div class="flex items-start justify-between gap-2">
                <div class="min-w-0">
                  <p class="font-semibold text-gray-900 text-sm sm:text-base">Dr. Sarah Johnson</p>
                  <p class="text-xs sm:text-sm text-gray-600">Cardiologist</p>
            ...
            <div class="p-3 sm:p-4 bg-gray-50 rounded-lg">
              <div class="flex items-center space-x-2 sm:space-x-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="font-semibold text-gray-900 text-sm sm:text-base">Dec 25, 2025</p>
            ...
            <div class="p-3 sm:p-4 bg-gray-50 rounded-lg">
              <div class="flex items-center space-x-2 sm:space-x-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="font-semibold text-gray-900 text-sm sm:text-base">10:00 AM</p>
          ...
          <div class="p-3 sm:p-4 bg-gray-50 rounded-lg">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              <div>
                ...
                <p class="font-medium text-gray-900 text-sm">Rajesh Kumar</p>
              </div>
              <div>
                <p class="text-xs text-gray-500">Mobile</p>
                <p class="font-medium text-gray-900 text-sm">+91 98765 43210</p>
              </div>
              <div>
                <p class="text-xs text-gray-500">Age</p>
                <p class="font-medium text-gray-900 text-sm">35 years</p>
              </div>
              <div>
                <p class="text-xs text-gray-500">Gender</p>
                <p class="font-medium text-gray-900 text-sm">Male</p>
              </div>
            </div>
            <div class="mt-3">
              <p class="text-xs text-gray-500">Chief Complaint</p>
              <p class="font-medium text-gray-900 text-sm">Chest pain and irregular heartbeat</p>
            </div>
          </div>
          ...
          <div class="p-3 sm:p-4 bg-gray-50 rounded-lg">
            <div class="flex flex-col sm:flex-row items-start sm:items-center sm:justify-between gap-3">
              <div>
                ...
                <p class="font-semibold text-gray-900 text-sm sm:text-base">New Patient</p>
              </div>
              <div class="text-right">
                <p class="text-xs text-gray-500">Consultation Fee</p>
                <p class="font-semibold text-sky-600 text-base sm:text-lg">₹800</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8">
      <button class="flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-white border-2 border-sky-600 text-sky-600 font-medium sm:font-semibold rounded-lg hover:bg-sky-50 transition-colors text-sm sm:text-base">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 mb-6 sm:mb-8">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3">
        <button class="flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-xs sm:text-sm font-medium">
          Google Calendar
        </button>
        <button class="flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 transition-colors text-xs sm:text-sm font-medium">
          Apple Calendar
    ...
    <div class="flex flex-col sm:flex-row items-center justify-between gap-3">
      <a href="{{ route('booking', ['step' => 1]) }}" class="w-full sm:w-auto px-6 py-2.5 sm:py-3 bg-gray-100 text-gray-700 font-medium sm:font-semibold rounded-lg hover:bg-gray-200 transition-colors text-sm sm:text-base text-center">
        Book Another Appointment
      </a>
      <a href="#" class="w-full sm:w-auto px-6 py-2.5 sm:py-3 bg-sky-600 text-white font-medium sm:font-semibold rounded-lg hover:bg-sky-700 transition-colors text-sm sm:text-base text-center">
        Go to Homepage
      </a>
    </div>
