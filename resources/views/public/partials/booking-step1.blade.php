    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
        <div class="flex items-center justify-between mb-6 sm:mb-8">
            <div class="flex flex-col items-center flex-1">
                <div class="w-8 h-8 sm:w-10 sm:h-10 bg-sky-600 text-white rounded-full flex items-center justify-center font-semibold mb-1 sm:mb-2 text-sm sm:text-base">1</div>
            ...
            <div class="flex flex-col items-center flex-1">
                <div class="w-8 h-8 sm:w-10 sm:h-10 bg-gray-200 text-gray-600 rounded-full flex items-center justify-center font-semibold mb-1 sm:mb-2 text-sm sm:text-base">2</div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6">
            ...
            <div class="mb-4 sm:mb-6">
                ...
                <div class="flex flex-wrap gap-2">
                    <button class="px-3 sm:px-4 py-2 bg-sky-600 text-white rounded-lg text-xs sm:text-sm font-medium">All</button>
                    <button class="px-3 sm:px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-xs sm:text-sm hover:border-sky-600 hover:text-sky-600">Cardiologist</button>
                    <button class="px-3 sm:px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-xs sm:text-sm hover:border-sky-600 hover:text-sky-600">Pediatrician</button>
                    <button class="px-3 sm:px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg text-xs sm:text-sm hover:border-sky-600 hover:text-sky-600">Orthopedic</button>
                </div>
            </div>

            <!-- Doctor Cards -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                <div class="border border-gray-200 rounded-xl p-3 sm:p-4 hover:border-sky-600 hover:shadow-md transition-all cursor-pointer">
                    <div class="flex items-start space-x-3 sm:space-x-4">
                        <img src="https://ui-avatars.com/api/?name=Dr+Rajesh+Sharma&background=0ea5e9&color=fff&size=80" class="w-16 h-16 sm:w-20 sm:h-20 rounded-lg flex-shrink-0" alt="Doctor">
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-gray-800 text-sm sm:text-base truncate">Dr. Rajesh Sharma</h3>
                ...
                <div class="border border-gray-200 rounded-xl p-3 sm:p-4 hover:border-sky-600 hover:shadow-md transition-all cursor-pointer">
                    <div class="flex items-start space-x-3 sm:space-x-4">
                        <img src="https://ui-avatars.com/api/?name=Dr+Priya+Mehta&background=8b5cf6&color=fff&size=80" class="w-16 h-16 sm:w-20 sm:h-20 rounded-lg flex-shrink-0" alt="Doctor">
                        <div class="flex-1 min-w-0">
                            <h3 class="font-semibold text-gray-800 text-sm sm:text-base truncate">Dr. Priya Mehta</h3>
        ...
        <div class="flex justify-end">
            <a href="{{ route('booking', ['step' => 2]) }}" class="px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-base bg-sky-600 text-white rounded-lg font-medium hover:bg-sky-700">Next Step</a>
        </div>
    </div>
