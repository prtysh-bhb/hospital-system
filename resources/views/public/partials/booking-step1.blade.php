    ...
    <form action="{{ route('booking.store') }}" method="POST">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-6">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6 mb-4 sm:mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                    ...
                    @forelse ($doctors as $doctor)
                        <label
                            class="border border-gray-200 rounded-xl p-3 sm:p-4 hover:border-sky-600 hover:shadow-md transition-all cursor-pointer block">
            ...
            <div class="flex justify-end">
                <button type="submit"
                    class="px-6 sm:px-8 py-2.5 sm:py-3 text-sm sm:text-base bg-sky-600 text-white rounded-lg font-medium hover:bg-sky-700">
                    Next Step
                </button>
            </div>
