        ...
        return Appointment::with(['patient'])
            ...
            ->map(function ($appointment) {
                return [
                    ...
                    'patient_age' => $appointment->patient->date_of_birth ? Carbon::parse($appointment->patient->date_of_birth)->age : '',
                    'patient_gender' => ucfirst($appointment->patient->gender ?? ''),
                    'patient_blood_group' => $appointment->patient->patientProfile->blood_group ?? '',
